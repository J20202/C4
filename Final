...
def checkForWin():
    ...
    for row in range(0, len(board), 1):
        for col in range(0, len(board[row]), 1):
            ...
            resultRightDiag = winRightDiag(row, col)
            resultLeftDiag = winLeftDiag(row, col)
            if resultDown == 1:
                win = 1
            elif resultDown == 2:
                win = 2
            if resultRight == 1:
                ...
                win = 2
            if resultRightDiag == 1:
                win = 1
            elif resultRightDiag == 2:
                win = 2
            if resultLeftDiag == 1:
                win = 1
            elif resultLeftDiag == 2:
                win = 2
